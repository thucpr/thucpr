...
$(function() {
    ...
    $(".header").load("header.html", function() {
        document.getElementById("login").innerHTML = storage.getItem("FULL_NAME");
...
//  Enter Key code  search , add , update =============================================
...
// Update department  And reset Form =============================================
